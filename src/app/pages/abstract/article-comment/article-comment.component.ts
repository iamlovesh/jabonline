...
export class ArticleCommentComponent extends Unsubscriber implements OnInit {
  ...
  ngOnInit(): void {
    this.subscriptions.push(
      this.api.commentArticleFetch(this.articleComment).subscribe(res => {
        this.commentArticleFetch = res;
      })
    );
  }
