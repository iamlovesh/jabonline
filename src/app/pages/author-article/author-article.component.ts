...
export class AuthorArticleComponent extends Unsubscriber implements OnInit {
  authorArticles: any;
  ...
  ngOnInit(): void {
    ...
    this.subscriptions.push(
      this.routes.queryParams.subscribe(res => {
        this.subscriptions.push(
          this.service.authorArticles({ "author": res.authorArticleName }).subscribe(res => {
            this.authorArticles = res.get_articles;
          })
        );
      })
    );
